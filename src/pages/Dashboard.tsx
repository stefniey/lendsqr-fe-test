...
const ITEMS_PER_PAGE = 9; // Number of items on figma
        ...
        <div className='stats'>
          ...
          <div className="user-stats-container">
            <div className="stat-box">
              <img src="./images/icon1.svg" alt="User Icon" className="stat-image" />
              <div className="stat-title">TOTAL USERS</div>
              <div className="stat-number">{totalUsers.toLocaleString()}</div>
            </div>
            <div className="stat-box">
              <img src="./images/icon2.svg" alt="User Icon" className="stat-image" />
              <div className="stat-title">ACTIVE USERS</div>
              <div className="stat-number">{activeUsers.toLocaleString()}</div>
            </div>
            <div className="stat-box">
              <img src="./images/icon3.svg" alt="User Icon" className="stat-image" />
              <div className="stat-title">USERS WITH LOANS</div>
              <div className="stat-number">{usersWithLoans.toLocaleString()}</div>
            </div>
            <div className="stat-box">
              <img src="./images/icon4.svg" alt="User Icon" className="stat-image" />
            ...
            <div className='user-details-table'>
              <div className='user-details-row'>
                ...
                <div className='user-details-item'>
                  ...
                  <p className='user-details-title'>Organisation

                    <img src='images/dropdown.svg' alt='Organisation' className='user-details-image' />
                  </p>
